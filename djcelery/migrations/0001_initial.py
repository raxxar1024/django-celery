    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queue', models.CharField(default=None, max_length=191, blank=True, help_text='Queue defined in CELERY_QUEUES', null=True, verbose_name='queue')),
                ('exchange', models.CharField(default=None, max_length=191, null=True, verbose_name='exchange', blank=True)),
                ('routing_key', models.CharField(default=None, max_length=191, null=True, verbose_name='routing key', blank=True)),
